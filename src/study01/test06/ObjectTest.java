...
public class ObjectTest {
	...
	public static void main(String[] args) {
		...
		objectTest = new ObjectTest(); //이건 덮어쓰는게아니고 새로 메모리가 만들어진것 그 후에 전에있던 메모리랑 objectTest에 연결고리가 끊기고 새로운 메모리에 연결이되는것
		System.out.println(objectTest.num1);
		System.out.println(objectTest.num2);
		...
		System.out.println(objectTest.str == objectTest2.str); //이거는 true인데 아마 string 자료형이 new 값이 필요하지않은 자바가 메모리 할당을 하기 때문에 true인것같음
